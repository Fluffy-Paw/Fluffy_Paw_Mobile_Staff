...
class _OrderLayoutState extends ConsumerState<OrderLayout> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      // Refresh counts và load data
      await ref.read(orderController.notifier).refreshAllOrderCounts();
        ...
        Container(
          ...
          child: ScrollablePositionedList.builder(
            ...
            itemBuilder: (context, index) {
              // Lấy số lượng order từ provider
              final currentCount = counts[orderStatuses[index]] ?? 0;
              ...
              return AbsorbPointer(
                ...
                child: InkWell(
                  onTap: () async {
                    ...
                    ref.read(selectedOrderStatus.notifier).state = 
                        orderStatuses[index];
                    
                    // Cập nhật danh sách orders và counts
                    await ref.read(orderController.notifier)
                  ...
                  child: OrderTabCard(
                    ...
                    orderCount: currentCount, // Sử dụng count từ provider
        ...
        builder: (context) => AlertDialog(
          ...
          title: Column(
            children: [
              ...
              Gap(12.h),
              Text(
                apiUrl.contains('Checkin') ? 'Xác nhận Check-in' : 'Xác nhận Check-out',
                style: AppTextStyle(context).title.copyWith(
                  fontSize: 20.sp,
