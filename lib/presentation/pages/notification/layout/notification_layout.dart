...
import 'package:fluffypawsm/presentation/pages/notification/components/notification_card.dart';
import 'package:fluffypawsm/presentation/pages/notification/components/notification_filter_bar.dart';
...
void initState() {
  ...
  // Đặt trong một Future.microtask để tránh gọi setState trong quá trình build
  Future.microtask(() {
    if (mounted) {
