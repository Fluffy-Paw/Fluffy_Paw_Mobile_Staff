...
class ServiceBrandCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final existingServices =
        ref.watch(serviceController.notifier).services ?? [];
    final isServiceExists =
        existingServices.any((s) => s.serviceTypeId == service.id);
          ...
          ClipRRect(
            ...
            child: Image.network(
              ...
              errorBuilder: (context, error, stackTrace) => Container(
                ...
                color: AppColor.gray,
                child:
                    Icon(Icons.error, size: 40.sp, color: AppColor.whiteColor),
              ),
            ),
          ),
