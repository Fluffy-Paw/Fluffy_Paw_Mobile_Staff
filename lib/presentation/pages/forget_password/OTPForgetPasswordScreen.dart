...
import 'package:fluffypawsm/presentation/pages/forget_password/NewPasswordScreen.dart';
  ...
  Future<void> _verifyOTP() async {
    ...
    try {
      final credential = PhoneAuthProvider.credential(
        verificationId: ref.read(verifyForgetPasswordProvider),
        smsCode: otp,
      );
    ...
    try {
      await FirebaseAuth.instance.verifyPhoneNumber(
        ...
        codeSent: (String verificationId, int? resendToken) {
          ref.read(verifyForgetPasswordProvider.notifier).state =
              verificationId;
          _startResendTimer();
